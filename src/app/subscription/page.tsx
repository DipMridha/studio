...
import { CheckCircle, CreditCard, ShieldCheck, Star, Phone, ShoppingCart } from "lucide-react"; // Added Phone, ShoppingCart
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <div className="flex items-center justify-center gap-4 my-3 text-muted-foreground">
